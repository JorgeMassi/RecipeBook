...
namespace RecipeBook.WebApp.Pages.Recipes
{
    public class RetrieveAllModel : PageModel
    {
        ...
        public RetrieveAllModel(IRecipeService recipeService, IUserService userService, ICategoryService categoryService, IDifficultyService difficultyService, IIngredientLineService ingredientLineService, IReviewService reviewService, ILogInService logInService, IRatingService ratingService)
		{
        ...
        public void OnGet()
        {
            ...
            Recipes = _recipeService.RetrieveAllAppprovedRecipe();
