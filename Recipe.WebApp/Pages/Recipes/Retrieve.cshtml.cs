...
namespace RecipeBook.WebApp.Pages.Recipes
{
	public class RetrieveModel : PageModel
	{
		...
		public RetrieveModel(IMeasureService measureService, IRecipeService recipeService, IUserService userService, ICategoryService categoryService, IDifficultyService difficultyService, IIngredientLineService ingredientLineService, IReviewService reviewService, ILogInService logInService)
		{
		...
		{
			GetSessionUser();
			Recipes = _recipeService.RetrieveAllByUser(user.Id);
